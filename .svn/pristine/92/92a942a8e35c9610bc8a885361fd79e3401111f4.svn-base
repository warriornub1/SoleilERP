    ...
    public static class DomainConstant
    {
        ...
        public static class LOVs
        {
            public static class Type
            {
                ...
                public const string ReceivingBays = "ReceivingBays";
                public const string PoTypes = "POTypes";
                public const string PoLineTypes = "POLineTypes";
            }
        }
        ...
        public static class AdvancedShipmentNotices
        {
            ...
            public static class BlAwbProvider
            {
        ...
        public static class CompanyStructure
        {
            ...
            {
                public const string Department = "1";
                public const string Division = "2";
