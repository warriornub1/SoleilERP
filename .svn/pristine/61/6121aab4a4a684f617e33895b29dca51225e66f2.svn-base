...
namespace SERP.Application.Masters.BranchPlants.DTOs.Response
{
    public class PagedBranchPlantResponseDto
    {
        public class PagedBranchPlantDetail
        {
            ...
            public PagedBranchPlantSiteDetail site { get; set; }
        }
        public class PagedBranchPlantSiteDetail
        {
