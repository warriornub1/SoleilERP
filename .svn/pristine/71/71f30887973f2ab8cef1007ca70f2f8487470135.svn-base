...
namespace SERP.Application.Common
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<UpdateInboundShipmentBLAWBRequestDto, InboundShipmentBLAWB>();
            ...
            CreateMap<ContainerListForAsnResponseDetail, ContainerResponse>();
            #endregion
            ...
            CreateMap<UpdateShipmentInfoRequestDto, InboundShipmentASN>();
            ...
            CreateMap<AsnInboundShipmentResponseDetail, InboundShipmentResponseDto>();
            CreateMap<UpdateInboundShipmentRequestDto, InboundShipmentRequestDto>();
            CreateMap<UpdateInboundShipmentRequestDto,  InboundShipment>();
            #endregion
            ...
            CreateMap<InvoiceAsnResponseDetail, InvoiceAsnResponse>();
            #endregion
            ...
            CreateMap<CompanyStructureCostCenterDb, CCCompanyStructureResponseModel>().ReverseMap();
            CreateMap<CostCenterLimitedModel, CostCenter>().ReverseMap();
            #endregion
            ...
            CreateMap<CompanyStructureRevenueCenterDb, RCCompanyStructureResponseModel>().ReverseMap();
            CreateMap<RevenueCenterLimitedModel, RevenueCenter>().ReverseMap();
            #endregion
            ...
            #region CompanyStructure
            CreateMap<CompanyStructureResponseModel, CompanyStructure>().ReverseMap();
            #endregion
