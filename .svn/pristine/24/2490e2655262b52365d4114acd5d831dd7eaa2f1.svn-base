...
namespace SERP.Application.Finance.RevenueCenters.Services
{
    public interface IRevenueCenterService
    {
        ...
        Task<List<RCCompanyStructureResponseModel>> GetCompanyStructureRevenueCenter();
        Task UpdateRevenueCenterCompanyStructureAsync(List<UpdateRevenueCenterCompanyStructureModel> requests);
        Task<IEnumerable<RevenueCenterLimitedModel>> GetAllLimitedAsync(bool onlyEnabled);
    }
}
