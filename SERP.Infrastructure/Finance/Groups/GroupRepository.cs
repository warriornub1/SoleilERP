...
namespace SERP.Infrastructure.Finance.Groups
{
    public class GroupRepository : GenericRepository<Group>, IGroupRepository
    {
        ...
        public async Task<Dictionary<string, Group>> GetGroupDictionary(List<string> parentGroup, string group_type)
        {
            return await _dbContext.Group.Where(x => parentGroup.Contains(x.group_code) && x.group_type == group_type)
