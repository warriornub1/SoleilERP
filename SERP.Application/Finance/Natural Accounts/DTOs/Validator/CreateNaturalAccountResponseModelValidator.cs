...
{
    public class CreateNaturalAccountResponseModelValidator : AbstractValidator<CreateNaturalAccountRequestModel>
    {
        private readonly IGroupRepository _groupRepository;
        private readonly ILovRepository _lovRepository;
        public CreateNaturalAccountResponseModelValidator(IGroupRepository groupRepository, ILovRepository lovRepository)
        {
